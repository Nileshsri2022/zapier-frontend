    ...
    <div className="px-2 pd-10">
      ...
      <div className=" flex flex-col md:flex-row w-full items-center flex-1 px-10">
        <div className="flex flex-col">
          <div className="text-3xl md:w-1/2 pt-20 pd-5 font-bold">
        ...
        <div className="border-2 flex justify-center flex-col border-gray-300 space-y-4 rounded-lg mt-14 py-5">
          <div className="mx-5">
            <button
              onClick={() => signIn()}
              type="button"
              className="text-white w-full bg-[#4285F4] hover:bg-[#4285F4]/90 focus:ring-4 focus:outline-none focus:ring-[#4285F4]/50 font-medium rounded-lg text-sm px-5 lg:px-24 py-2.5 text-center inline-flex items-center justify-between mr-2 mb-2"
            >
              <svg
          ...
          <div className="px-5 py-2">
            ...
            <input
              ...
              type="text"
              id="first_name"
              className="bg-transparent border border-black text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"
              required
            />
          </div>
          <div className="px-5 py-2">
